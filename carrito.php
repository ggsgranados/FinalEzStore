							...
							<ul class="dropdown-menu multi-column columns-3">
								<div class="row">
									...
									<div class="col-sm-3">
										<ul class="multi-column-dropdown">
											<h6>Audio y Video</h6>
											<li><a href="products.html">Pantallas</a></li>
											
											<li><a href="products.html">Auriculares <span>New</span></a></li>
											<li><a href="products.html"><i>Audio y Video</i></a></li>
										</ul>
									</div>
									<div class="col-sm-2">
										<ul class="multi-column-dropdown">
											...
											<li><a href="products.html">Disco duros</a></li>
...
<?php
	...
	for ($i=1; $i < $longitud ; $i++) {
		$modelo[] = $_POST['w3ls_id_'.$i]; 
		$nombre[] = $_POST['w3ls_item_'.$i];
		$monto[] = $_POST['amount_'.$i];
		$cantidad[] = $_POST['quantity_'.$i];
		$parcial[]=$monto[$i-1]*$cantidad[$i-1];
		$total= $total + $parcial[$i-1];

	}
		$sql= "DELETE FROM carrito WHERE id_usuario = '1'";
		mysqli_query($conexion,$sql);
		$sql = "SELECT nombre FROM `usuario` WHERE id_usuario = '1'";
		$actual = mysqli_query($conexion,$sql);
		$row= $actual->fetch_array();

	for ($i=0; $i <$longitud-1 ; $i++) { 
		
		
			//$sql= "DELETE FROM carrito WHERE id_usuario = 'gg.sgranados@gmail.com'";
			//mysqli_query($conexion,$sql);
		$sql="INSERT INTO carrito (id_usuario,id_producto,cantidad) VALUES ('1','$modelo[$i]','$cantidad[$i]')";
	...
	/*for ($i=0; $i < $longitud-1 ; $i++) { 
		...
		echo "Modelo: ". $modelo[$i]. "<br/>";		
		echo "Descripcion: ". $nombre[$i]. "<br/>";
		echo "Precio individual: ". $monto[$i]. "<br/>";
		echo "Cantidad: ". $cantidad[$i]. "<br/>";
		echo "Total parcial: ". $parcial[$i]. "<br/>"."<br/>";
		
	}
	echo "Total a cancelar: ". $total. "<br/>";	
	*/
?>
<br><br><br>
<h1 align="center">Productos en el carrito</h1>
...
<br>
<br>
<h4 align="center">Cliente: <?php echo $row['nombre']. "<br/>"; ?></h4>
<h4 align="center">Total a cancelar (USD): $<?php echo $total. "<br/>"; ?></h4>


<div class="cart cart box_1">
		<input type="submit" value="Pasar a caja"/>
</div>
